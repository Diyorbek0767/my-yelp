  ...
  return (
    <div className="App">
      ...
      <Container>
        <Row className="mt-3">
            <Form>
              <Form.Group as={Col} md="40" controlId="formDataName">
                <Form.Control onChange={e => setFormData({ ...formData, 'name': e.target.value})} type="text" value={formData.name} placeholder="Name" />
              </Form.Group>
              <br />
              ...
              <Form.Group controlId="formDataCity">
                <Form.Control onChange={e => setFormData({ ...formData, 'city': e.target.value})} type="text" value={formData.city} placeholder="City" />
              </Form.Group>
              <br />
            </Form>
            <Button className="createBtn" onClick={createRestaurant} as={Col} md="2"  >
                Create
            </Button>
        </Row>
        <hr />
        ...
        <Row className="my-3">
            <Col>
            <Table className=' tableCol' striped bordered hover>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
